            ...
            for i in 0..num_threads {
                ...
                handles.push(thread::spawn(move || {
                    for _ in start..end {
                        ...
                        let date_val = fns::generate_random_date(
                            NaiveDate::from_ymd(2022, 1, 1),
                            NaiveDate::from_ymd(2023, 12, 31),
                        );
                        let datetime_val = fns::generate_random_datetime(
                            NaiveDateTime::from_timestamp(1640995200, 0),
                            NaiveDateTime::from_timestamp(1643620800, 0),
                        );
